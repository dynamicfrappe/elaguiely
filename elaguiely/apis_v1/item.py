...
# @frappe.whitelist(allow_guest=True)
# @jwt_required
# def get_items_prices_1(fav=None, customer_id=None, MainGroupID=None, SubGroup1ID=None, SubGroup2ID=None, SupplierID=None,
#                      CustomerID=None, BounsId=None, fromadv=None, advId=None, advtype=None, **kwargs):
#     try:
#         response = []
#         items = []
...
def get_items_prices():
    ...
    items = frappe.get_all(
        'Item',
        fields=['name', 'item_name', 'arabic_name', 'image', 'description', 'brand', 'item_group'],
